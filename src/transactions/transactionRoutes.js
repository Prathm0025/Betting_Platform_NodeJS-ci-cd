...
transactionRoutes.post("/", (0, middleware_1.verifyRole)(["admin", "agent"]), transactionController_1.default.transaction);
...
transactionRoutes.get("/all/:agentId", (0, middleware_1.verifyRole)(["agent", "admin"]), transactionController_1.default.getAgentPlayerTransaction);
transactionRoutes.get("/all/by-username/:username", (0, middleware_1.verifyRole)(["agent", "admin"]), transactionController_1.default.getAgentPlayerTransaction);
transactionRoutes.get("/player/:playerId", middleware_1.checkUser, (0, middleware_1.verifyRole)(["admin", "agent"]), transactionController_1.default.getSpecificPlayerTransactions);
